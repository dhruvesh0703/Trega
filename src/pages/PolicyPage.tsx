...
export const PolicyPage: React.FC = () => {
  ...
  const policyType = path.split('/').pop()?.toLowerCase();

  const getTitle = () => {
    switch (policyType) {
      case 'terms': return 'Terms & Conditions';
      case 'privacy': return 'Privacy Policy';
      case 'refund': return 'Refund and Cancellation Policy';
  ...
  return (
    <div className="min-h-screen bg-stone-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white rounded-3xl shadow-sm border border-stone-200 p-8 sm:p-12">
        <div className="mb-8 border-b border-stone-100 pb-8 text-center sm:text-left">
          <h1 className="text-3xl font-black text-stone-900 font-display tracking-tight">
            {getTitle()}
          </h1>
          <p className="text-sm text-stone-500 mt-2 font-medium">Last Updated: August 2026</p>
        </div>

        <div className="prose prose-sm sm:prose-base prose-stone max-w-none text-stone-600 space-y-6">
          {policyType === 'terms' && (
            <>
              ...
              <p>This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://trega.in/ ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').</p>
              <p>The Platform is owned by DHRUVESH SHESHRAO PATIL with its registered office at TREGA MARKETPLACE, Keshavnagar, Mundhwa, Local Area 411036 (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our').</p>
          ...
          {policyType === 'privacy' && (
            <>
              ...
              <h3 className="text-lg font-bold text-stone-900 mt-6 mb-3">Sharing</h3>
              ...
              <h3 className="text-lg font-bold text-stone-900 mt-6 mb-3">Security Precautions</h3>
              ...
              <h3 className="text-lg font-bold text-stone-900 mt-6 mb-3">Data Deletion and Retention</h3>
              ...
              <h3 className="text-lg font-bold text-stone-900 mt-6 mb-3">Your Rights</h3>
              <p>You may access, rectify, and update your personal data directly through the functionalities provided on the Platform.</p>

              <h3 className="text-lg font-bold text-stone-900 mt-6 mb-3">Consent</h3>
              ...
              <h3 className="text-lg font-bold text-stone-900 mt-6 mb-3">Changes to this Privacy Policy</h3>
              ...
              <div className="mt-8 p-4 bg-stone-100 rounded-xl">
                <h4 className="font-bold text-stone-900 mb-2">Grievance Officer</h4>
                <p>Insert Name of the Office:</p>
                <p>Designation:</p>
                <p>Insert Name and Address of the Company: TREGA MARKETPLACE, Keshavnagar, Mundhwa, Local Area 411036</p>
                <p>Contact us: dhruveshpatil03@gmail.com | +91 9130851374</p>
          ...
          {policyType === 'refund' && (
            <>
              ...
              <ul className="list-disc pl-5 space-y-3">
                ...
                <li>DHRUVESH SHESHRAO PATIL does not accept cancellation requests for perishable items like flowers, eatables, etc. However, the refund / replacement can be made if the user establishes that the quality of the product delivered is not good.</li>
                <li>In case of receipt of damaged or defective items, please report to our customer service team. The request would be entertained once the seller/ merchant listed on the Platform, has checked and determined the same at its own end. This should be reported within 1 days of receipt of products. In case you feel that the product received is not as shown on the site or as per your expectations, you must bring it to the notice of our customer service within 1 days of receiving the product. The customer service team after looking into your complaint will take an appropriate decision.</li>
                ...
                <li>In case of any refunds approved by DHRUVESH SHESHRAO PATIL, it will take 4 days for the refund to be processed to you.</li>
              </ul>
            </>
          )}
          ...
          {policyType === 'contact' && (
            <div className="space-y-6">
              <p className="text-lg text-stone-600">We're here to help! If you have any questions, concerns, or need assistance with your TREGA MARKETPLACE experience, please don't hesitate to reach out to us.</p>
              
              <div className="bg-stone-50 rounded-2xl p-6 border border-stone-200 mt-8">
                <h3 className="text-xl font-bold text-stone-900 mb-6 font-display">Contact Information</h3>
                
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 rounded-full bg-brand-100 flex items-center justify-center shrink-0">
                      <svg className="w-5 h-5 text-brand-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                    </div>
                    <div>
                      <h4 className="text-sm font-bold text-stone-900">Email Support</h4>
                      <a href="mailto:dhruveshpatil03@gmail.com" className="text-brand-600 hover:text-brand-700 font-bold mt-1 inline-block">dhruveshpatil03@gmail.com</a>
                      <p className="text-xs text-stone-500 mt-1">We aim to respond to all inquiries within 24 hours.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-sm font-bold text-stone-900">Phone Support</h4>
                      <a href="tel:+919130851374" className="text-stone-700 hover:text-brand-600 font-bold mt-1 inline-block">+91 91308 51374</a>
                      <p className="text-xs text-stone-500 mt-1">Monday - Friday (9:00 AM - 6:00 PM)</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-sm font-bold text-stone-900">Registered Office</h4>
                      <p className="text-stone-700 mt-1 leading-relaxed">TREGA MARKETPLACE<br/>Keshavnagar, Mundhwa<br/>Local Area, Maharashtra 411036<br/>India</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {!['terms', 'privacy', 'refund', 'return', 'shipping', 'contact'].includes(policyType || '') && (
            <p>Policy not found. Please navigate back to the main site.</p>
          )}
        </div>
        
        <div className="mt-12 text-center">
          <a href="/" className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-sm font-bold rounded-xl text-white bg-brand-600 hover:bg-brand-700 transition-colors">
            Return to Trega
          </a>
        </div>
      </div>
